...
- [Core Types](types.qmd) -- `CompiledModel`, `Population`, `FitResult`, `FitOptions`, etc.
- [Fitting Functions](fitting.qmd) -- `fit()`, `fit_from_files()`, `run_model_with_data()`
- [Simulation](simulation.qmd) -- `simulate()`, `simulate_with_seed()`, `predict()`
- [Parsing](parsing.qmd) -- `parse_model_file()`, `parse_full_model_file()`, `read_nonmem_csv()`
