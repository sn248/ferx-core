...
> `survreg` exactly). A three-tool cross-check on the n=100 Weibull file agrees: **NONMEM
> LAPLACIAN (ω² 0.175) and nlmixr2 FOCEI (0.173) land together, below ferx FOCEI (0.204)** —
> structural params and −2LL match across all three (≤0.5% / identical OFV), with the spread
> isolated to the weakly-identified ω². Prefer **SAEM/IMP** for frailty TTE on nonlinear
