...
#486, for IOV since #575, and for IOV subjects that also have time-varying covariates
since #590. The IOV expression-scale quotient follows production semantics: the scale is
...
The static ODE walk evaluates one scale jet per subject. The ODE IOV walk
