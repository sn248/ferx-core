...
for IOV subjects that also have time-varying covariates since #590. The IOV
expression-scale quotient follows production semantics: the scale is
evaluated once per occasion group with the subject-level covariate snapshot, while the ODE
