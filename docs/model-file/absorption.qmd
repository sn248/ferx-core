...
([#530](https://github.com/FeRx-NLME/ferx-core/issues/530)). As for a plain
`zero_order` model, this reverts to finite differences only in combination with an
estimated lagtime, an EVID 3/4 reset, or time-varying covariates.
