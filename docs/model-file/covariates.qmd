...
subject-static post-walk quotient) or an **`EVID=2` covariate-only breakpoint**
(both since #486). Time-varying covariates with **dose lagtime** on the closed-form
analytical models still fall back to the finite-difference gradient. (See
